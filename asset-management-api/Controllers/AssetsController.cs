...
//         // POST batch asset api/assets/batch
//         [HttpPost("newAsset")]
//         public ActionResult<GetAssetDto> CreateAsset(AssetCreateDto assetCreateDto)
//         {
//             assetCreateDto.LastModifiedBy = "userName";
//             assetCreateDto.CreatDate = DateTime.Now.Date;
//             assetCreateDto.LastModifiedDate = DateTime.Now.Date;
//             assetCreateDto.CommissionedDate = DateTime.ParseExact("02/02/2024", "dd/mm/yyyy", CultureInfo.InvariantCulture);

//             foreach (var prop in assetCreateDto.GetType().GetProperties())
//             {
//                 Console.WriteLine($"{prop.Name}: {prop.GetValue(assetCreateDto)}");
//             }

//             try
//             {
//                 var assetModel = _mapper.Map<Asset>(assetCreateDto);
//                 // print out data in console// print out data in console
//                 // foreach (var prop in assetModel.GetType().GetProperties())
//                 // {
//                 //     Console.WriteLine($"{prop.Name}: {prop.GetValue(assetModel)}");
//                 // }
//             }
//             catch (Exception e)
//             {
...
//             // _repository.NewAsset(assetModel);
